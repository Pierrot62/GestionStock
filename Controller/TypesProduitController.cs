...
{
    class TypesProduitController : ControllerBase
    {
        ...
        {
            _service = new TypesProduitServices(_context);
            var config = new MapperConfiguration(cfg =>
            {
                cfg.AddProfile<TypesProduitProfiles>();
            });
        ...
        [HttpGet]
        public IEnumerable<TypesProduitDTO> GetAllTypesProduit()
        {
            IEnumerable<TypesProduit> listeTypesProduit = _service.GetAllTypesProduit();
            return _mapper.Map<IEnumerable<TypesProduitDTO>>(listeTypesProduit);
        }
